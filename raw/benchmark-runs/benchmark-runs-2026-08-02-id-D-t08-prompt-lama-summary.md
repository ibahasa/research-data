# Hasil run `2026-08-02-id-D-t08-prompt-lama`

**run_id:** `ddc5acd9-a9b5-4d71-9b0c-2c3ff1170071` · **tanggal:** 2026-08-01 · **set:** `id-D-draft-v0` · **template prompt:** `mcq-v1`

| Model | Panggilan | Error | Gagal format | Inti | Dasar | Kontrol ditahan | Mengarang | Token in/out |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `gemini-3.1-flash-lite-preview-or` | 48 | 0 | 0 | 100.0% | 100.0% | — | — | 4665 / 390 |
