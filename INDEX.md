...
| [`indonesian-normalization-prompt-arms`](./raw/indonesian-normalization-prompt-arms/) — Indonesian text normalization: the same 69 items and answer key put to four AI models under three different prompt wordings, scored as two opposing abilities — substituting non-standard words versus leaving already-standard words alone. Sentences and key withheld, figures only. See PROVENANCE | 4 | 2026-08-13 | `ae5dac98` |
